...
namespace EletricAzimuth
{
    public class TrainingTypeSelection : VisualElement
    {
        // UxmlFactory and UxmlTraits a
        public new class UxmlFactory : UxmlFactory<TrainingTypeSelection, UxmlTraits> {}
